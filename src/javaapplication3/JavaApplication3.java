...
{  
    ...
    public Room addroom(Room node,int roomNumber)
    {
      ...
      public void ReservationRoom(Room node,int roomnumber)
      {
...
public class JavaApplication3 {
    ...
    public static void main(String[] args) {
      ...
      //  hotelreservation.postorder(root);
       ...
       // System.out.println("Rooms in the hotel:");
       // hotelreservation.display(root);
       hotelreservation.ReservationRoom(root, 101);
       hotelreservation.ReservationRoom(root, 103);
       hotelreservation.ReservationRoom(root, 105);
